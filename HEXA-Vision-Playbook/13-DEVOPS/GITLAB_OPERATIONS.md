...
- `HEXA-Vision-Playbook/13-DEVOPS/` — Deployment guides use GitLab URLs
- `HEXA-Vision-Playbook/15-QUALITY/` — DEPENDENCY_REPORT uses GitLab Dependency Scanning

### Docs (new)
- `HEXA-Vision-Playbook/13-DEVOPS/GITLAB_MIGRATION.md` — Migration memory
