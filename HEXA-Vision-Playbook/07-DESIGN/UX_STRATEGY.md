...
- **Smart Behavior:** Sticky navigation that hides on scroll-down and reveals on scroll-up.
- **Context Awareness:** Active section detection with elegant, non-distracting indicators.
- **Transitions:** Fullscreen menus must feel like a cinematic curtain, not a popup.
- **Accessibility:** Full keyboard navigation support and ARIA-compliant roles.

### II. The Mobile-First Approach
Do NOT copy the desktop experience.
- **Thumb-Zone Design:** All critical interactions must be within easy reach of the thumb.
- **Native Gestures:** Implement fluid swipe and drag gestures for galleries and sliders.
- **Optimized Transitions:** Simplified motion for mobile to ensure instantaneous response.
...
- **Alternating Density:** Balance "Heavy" sections (dense info) with "Calm" sections (minimalist visuals).
- **Layered Depth:** Use subtle parallax and z-axis shifts to create a sense of physical space.
- **Progressive Reveal:** Content should enter the viewport with a choreographed sequence (staggered fades and slides).
...
- **Buttons/Links:** Subtle scale-down on click, elegant hover states with color shifts or border glows.
- **Cards:** Depth shifts (lifting) and subtle glow effects on hover.
- **Cursor Experience:** A custom, lightweight cursor that changes state based on context (e.g., transforms into a "View" button over images).
- **Loading States:** No blank screens. Use skeleton screens or branded, cinematic loaders.
