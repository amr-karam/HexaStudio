...
For the complete base performance checklist, see [`HEXA-Vision-Playbook/17-CHECKLISTS/PERFORMANCE_CHECKLIST.md`](../../17-CHECKLISTS/PERFORMANCE_CHECKLIST.md).

For performance budgets and standards, see [`HEXA-Vision-Playbook/06-STANDARDS/PERFORMANCE_STANDARDS.md`](./PERFORMANCE_STANDARDS.md).
