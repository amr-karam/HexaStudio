...
| **Disaster Recovery** | Restore from latest `pg_dump` + WAL archive. See `HEXA-Vision-Playbook/13-DEVOPS/DISASTER_RECOVERY.md` for step-by-step DR procedure |
...
| **Disaster Recovery** | Run `backup-verify` container (profile `verify`) to validate latest backup integrity. Restore using `pg_restore` from latest valid dump. See `HEXA-Vision-Playbook/13-DEVOPS/BACKUP.md` for detailed restore procedure |
...
- System Architecture: `HEXA-Vision-Playbook/01-ARCHITECTURE/SYSTEM_ARCHITECTURE.md`
- Deployment Strategy: `HEXA-Vision-Playbook/13-DEVOPS/DEPLOYMENT_STRATEGY.md`
- Backup Procedures: `HEXA-Vision-Playbook/13-DEVOPS/BACKUP.md`
- Disaster Recovery: `HEXA-Vision-Playbook/13-DEVOPS/DISASTER_RECOVERY.md`
- Monitoring Setup: `HEXA-Vision-Playbook/13-DEVOPS/monitoring-setup.md`
- Infrastructure Spec: `HEXA-Vision-Playbook/13-DEVOPS/infrastructure.md`
- Docker Compose Reference: `HEXA-Vision-Playbook/13-DEVOPS/DOCKER_COMPOSE.md`
