...
- [x] **VERIFIED — leaked placeholder PAT was never valid:** `glpat-OrchDeploy2026…` (scrubbed from history on Aug 16) returns 401 — it never existed as a live token, no action needed.
