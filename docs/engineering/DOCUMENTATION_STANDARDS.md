...
|------|----------|---------|
| **Playbook** | `docs/` | Operating manual, standards, processes |
...
| **Sprint** | `docs/sprints/` | Sprint backlogs and retrospectives |
| **ADR** | `docs/adr/` | Architecture Decision Records |
| **Templates** | `docs/templates/` | Reusable document templates |
| **Meeting Notes** | `docs/meeting-notes/` | Meeting records |
