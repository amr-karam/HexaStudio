...
- [QUALITY_GATES.md](docs/quality/QUALITY_GATES.md) — CI Quality Gates.
- [UNIT_TESTS.md](docs/quality/UNIT_TESTS.md) — Unit test specifications.
- [ACCESSIBILITY_AUDIT.md](docs/quality/ACCESSIBILITY_AUDIT.md) — WCAG audit procedures.
- [CURRENT_SPRINT.md](docs/product/CURRENT_SPRINT.md) — S-018 E2E smoke test deliverables.
