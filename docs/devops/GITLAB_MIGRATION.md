...
- UPDATE: `README.md`, `CONTRIBUTING.md`, `docs/**/README.md` — clone URLs
- UPDATE: `docs/devops/**/LOCAL_DEPLOYMENT.md`, `server-setup.md`
- UPDATE: `docs/quality/DEPENDENCY_REPORT.md` — Dependabot → GitLab Dependency Scanning
