        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((item, idx) => (
            <motion.div
              ...
              className="p-12 border border-border hover:border-accent/30 transition-all duration-700 bg-background/30 backdrop-blur-sm flex flex-col justify-between group"
            >
              <div>
                <svg
                  className="mb-10 text-accent/20 group-hover:text-accent/50 transition-colors duration-500"
                  width="32"
                  height="24"
                  viewBox="0 0 24 18"
                  fill="currentColor"
                >
                  <path d="M0 18V10.5C0 7 0.8 3.8 2.4 0.9L7.5 0V4.5H4.5C3.4 4.5 2.6 5 2.1 6C1.5 7 1.2 8.3 1.2 10V18H0ZM14.8 18V10.5C14.8 7 15.6 3.8 17.2 0.9L22.3 0V4.5H19.3C18.2 4.5 17.4 5 16.9 6C16.3 7 16 8.3 16 10V18H14.8Z" />
                </svg>
                <p className="text-base text-neutral-400 font-light leading-relaxed mb-12 italic">
                  "{item.quote}"
                </p>
              </div>
              <div>
                <p className="text-xs uppercase tracking-widest text-foreground font-medium mb-1">
                  {item.author}
                </p>
