 ...
 * Reveals run through the shared ScrollFadeIn (HEXA motion tokens,
 * reduced-motion aware via MotionConfig).
 */
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-4xl text-center">
        <ScrollFadeIn className="font-mono text-[10px] uppercase tracking-[0.5em] text-sl-gold-subtle/70">
        ...
        <ScrollFadeIn delay={0.15}>
          <blockquote className="mt-12 font-serif text-[clamp(1.5rem,3.5vw,2.75rem)] font-light leading-[1.25] tracking-[-0.01em] text-sl-alabaster">
        ...
        <ScrollFadeIn delay={0.4}>
          <p className="mt-12 text-sm font-light leading-relaxed text-sl-mist/60">
