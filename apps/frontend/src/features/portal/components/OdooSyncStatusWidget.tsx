...
export function OdooSyncStatusWidget() {
  ...
  return (
    <div className="flex items-center space-x-3 bg-sl-void/80 border border-sl-obsidian rounded-2xl px-4 py-2 text-xs text-neutral-200 backdrop-blur-xl">
      ...
      <div className="flex items-center space-x-1 text-[11px] text-sl-mist/60 font-mono">
      ...
      <button
        ...
        disabled={isSyncing}
        className="ml-2 text-[10px] bg-sl-obsidian hover:bg-neutral-700 text-amber-400 border border-amber-500/20 px-2 py-0.5 rounded-md transition-colors font-semibold"
      >
