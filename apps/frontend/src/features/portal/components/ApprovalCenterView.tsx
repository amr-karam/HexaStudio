...
const STATUS_PILLS: Record<PendingApproval['status'], string> = {
  ...
  revision_requested: 'border-destructive/20 bg-destructive/10 text-destructive',
};
  ...
  return (
    <div className="space-y-8">
      ...
      {persistError && (
        <p
          role="alert"
          className="rounded-xl border border-destructive/20 bg-destructive/10 px-4 py-3 font-mono text-[0.625rem] uppercase tracking-[0.2em] text-destructive"
        >
          {persistError}
        </p>
      )}
