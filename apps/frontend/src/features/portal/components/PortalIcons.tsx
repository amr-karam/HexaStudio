...
/**
 * HEXA Portal — Inline SVG Icon System
 *
 * All icons use a consistent 24×24 viewBox, stroke-based rendering,
 * and inherit the current text color. No external icon library needed.
 *
 * Convention: PascalCase names, kebab-case keys in ICON_PATHS.
 */
