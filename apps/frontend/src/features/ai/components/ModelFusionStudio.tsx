...
export function ModelFusionStudio() {
  ...
  const renderReasoningChain = (chain: string[] = []) => {
    ...
    return (
      <div className="mt-2">
        <span className="text-[10px] font-mono text-text-sl-mist/60 uppercase tracking-widest block mb-1">Reasoning Chain</span>
              ...
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
                {streamEnabled && streamMeta && (
                  <div className="grid grid-cols-2 gap-3">
                    <div className="p-3 bg-obsidian-raised rounded-xl border border-sl-silver/20">
                      <span className="text-[10px] font-mono text-text-sl-mist/60 uppercase tracking-widest block mb-1">Mode</span>
                      <p className="text-xl font-mono text-sl-alabaster">{streamMeta.mode}</p>
                    </div>
                    <div className="p-3 bg-obsidian-raised rounded-xl border border-sl-silver/20">
                      <span className="text-[10px] font-mono text-text-sl-mist/60 uppercase tracking-widest block mb-1">Models</span>
                ...
                {!streamEnabled && response && (
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="p-3 bg-obsidian-raised rounded-xl border border-sl-silver/20">
                      <span className="text-[10px] font-mono text-text-sl-mist/60 uppercase tracking-widest block mb-1">Winner Score</span>
                      <p className="text-xl font-mono text-sl-gold-hover">{response.winnerScore}</p>
                    </div>
                    <div className="p-3 bg-obsidian-raised rounded-xl border border-sl-silver/20">
                      <span className="text-[10px] font-mono text-text-sl-mist/60 uppercase tracking-widest block mb-1">Latency</span>
                      <p className="text-xl font-mono text-sl-alabaster">{response.telemetry.totalLatencyMs} ms</p>
                    </div>
                    <div className="p-3 bg-obsidian-raised rounded-xl border border-sl-silver/20">
                      <span className="text-[10px] font-mono text-text-sl-mist/60 uppercase tracking-widest block mb-1">Candidates</span>
                    ...
                    <div className="p-3 bg-obsidian-raised rounded-xl border border-sl-silver/20">
                      <span className="text-[10px] font-mono text-text-sl-mist/60 uppercase tracking-widest block mb-1">Avg Reasoning</span>
                      <p className="text-xl font-mono text-sl-alabaster">{response.telemetry.avgReasoningConfidence ?? '—'}</p>
                    </div>
                    <div className="p-3 bg-obsidian-raised rounded-xl border border-sl-silver/20">
                      <span className="text-[10px] font-mono text-text-sl-mist/60 uppercase tracking-widest block mb-1">Winner Reasoning</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  {(streamEnabled ? candidates : response?.candidates ?? []).map((candidate) => (
                    ...
                    >
                      <span className="text-[11px] font-mono text-sl-gold-hover uppercase tracking-widest block mb-1">{candidate.model}</span>
                      ...
                      <div className="mt-4 space-y-3">
                        <div className="flex gap-3">
                          <div className="p-3 bg-obsidian-raised rounded-xl border border-sl-silver/20 flex-1">
                            <span className="text-[10px] font-mono text-text-sl-mist/60 uppercase tracking-widest block mb-1">Reasoning Confidence</span>
                            <p className="text-xl font-mono text-sl-gold-hover">{candidate.reasoningConfidence ?? '—'}</p>
                          </div>
                          <div className="p-3 bg-obsidian-raised rounded-xl border border-sl-silver/20 flex-1">
                            <span className="text-[10px] font-mono text-text-sl-mist/60 uppercase tracking-widest block mb-1">Rank</span>
