...
export default function StudioAnalyticsPage() {
  ...
  const badge = (variant: "secondary" | "destructive" | "outline", label: string) => {
    ...
    const styles = {
      secondary: "bg-sl-obsidian text-sl-mist/60",
      destructive: "bg-destructive text-destructive-foreground",
      outline: "border border-sl-silver/20 text-sl-mist/60",
    };
          ...
          <div className="border-b">
            <div className="flex gap-2">
              <button
                ...
                className={`px-4 py-2 text-sm font-medium ${activeTab === "overview" ? "bg-sl-obsidian" : "hover:bg-sl-obsidian"}`}
              >
                Overview
              </button>
              <button
                onClick={() => setActiveTab("quality")}
                className={`px-4 py-2 text-sm font-medium ${activeTab === "quality" ? "bg-sl-obsidian" : "hover:bg-sl-obsidian"}`}
              >
                Quality Settings
              </button>
              <button
                onClick={() => setActiveTab("telemetry")}
                className={`px-4 py-2 text-sm font-medium ${activeTab === "telemetry" ? "bg-sl-obsidian" : "hover:bg-sl-obsidian"}`}
              >
                Telemetry
              </button>
            </div>
