            ...
            <nav className="flex gap-1 bg-obsidian p-1 rounded-lg border border-slate">
              <button 
                ...
                className={`px-4 py-1.5 text-[10px] font-bold uppercase tracking-wider transition-all rounded-md ${
                  activeTab === 'critic' ? 'bg-accent text-void' : 'text-text-muted hover:text-text-primary'
                }`}
              >
                Component Audit
              </button>
              <button 
                ...
                className={`px-4 py-1.5 text-[10px] font-bold uppercase tracking-wider transition-all rounded-md ${
                  activeTab === 'balance' ? 'bg-accent text-void' : 'text-text-muted hover:text-text-primary'
                }`}
              >
                Color Balance
              </button>
