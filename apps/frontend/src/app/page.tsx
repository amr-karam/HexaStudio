...
export const metadata: Metadata = {
  ...
  description:
    "HexaStudio is a premium global architecture visualization and digital studio platform, specializing in world-class 3D/WebGL experiences and project storytelling.",
  alternates: {
...
export default async function HomePage() {
  ...
  return (
    <div className="bg-sl-void">
      ...
      <div
        className="absolute inset-0 gradient-radial-gold opacity-20 pointer-events-none"
        aria-hidden="true"
      />
      <script
