...
const fallbackProjects: Record<string, Partial<Project>> = {
  ...
  'lumina-pavilion': {
    ...
    coverImage: 'https://images.unsplash.com/photo-1487958449943-2429e8be6c6?w=1200&q=80',
  ...
  'azure-heights': {
    ...
    coverImage: 'https://images.unsplash.com/photo-1600607687644-c94bf900a9a7?w=1200&q=80',
