      ...
      <div className="w-full px-8 md:px-16 relative z-10">
        ...
        <div className="max-w-3xl flex flex-col gap-8 text-neutral-400 font-light leading-relaxed text-base">
          ...
          <div className="pt-6 border-t border-border/20">
            <h2 className="text-sm uppercase tracking-[0.3em] text-foreground font-medium mb-4">Intellectual Property</h2>
            <p>
          ...
          <div className="pt-6 border-t border-border/20">
            <h2 className="text-sm uppercase tracking-[0.3em] text-foreground font-medium mb-4">Project Scope</h2>
            <p>
          ...
          <div className="pt-6 border-t border-border/20">
            <h2 className="text-sm uppercase tracking-[0.3em] text-foreground font-medium mb-4">Limitation of Liability</h2>
            <p>
          ...
          <div className="pt-6 border-t border-border/20">
            ...
            <p>
              For questions about these terms, email us at <a href="mailto:info@hexastudio.net" className="text-accent hover:underline transition-colors duration-300">info@hexastudio.net</a>.
            </p>
          </div>
