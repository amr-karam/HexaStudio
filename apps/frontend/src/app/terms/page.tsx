    ...
    <main className="min-h-screen bg-background pt-40 pb-32">
      <div className="max-w-3xl mx-auto px-8 md:px-16">
        ...
        <div className="flex flex-col gap-8 text-neutral-400 font-light leading-relaxed text-base">
          ...
          <h2 className="text-lg uppercase tracking-widest text-foreground font-medium pt-4">Intellectual Property</h2>
          <p>
          ...
          <h2 className="text-lg uppercase tracking-widest text-foreground font-medium pt-4">Project Scope</h2>
          <p>
          ...
          <h2 className="text-lg uppercase tracking-widest text-foreground font-medium pt-4">Limitation of Liability</h2>
          <p>
            HexaStudio is not liable for indirect damages arising from the use of our services. Our total liability is limited to the amount paid for the specific project.
          </p>
          <h2 className="text-lg uppercase tracking-widest text-foreground font-medium pt-4">Contact</h2>
          <p>
