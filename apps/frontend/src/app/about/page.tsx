      ...
      <section className="px-8 md:px-16 py-32 bg-surface border-y border-border/50">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div className="relative aspect-square overflow-hidden bg-surface-light border border-border/30">
              <Image
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            {milestones.map((m, i) => (
              ...
              >
                <span className="text-3xl font-serif italic text-accent">{m.year}</span>
                <h3 className="text-lg font-medium text-foreground">{m.label}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            {values.map((v, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.8, delay: i * 0.1, ease: [0.16, 1, 0.3, 1] }}
                className="p-8 border border-border/30 bg-background/50 backdrop-blur-sm"
              >
                <h3 className="text-xl font-serif font-light text-foreground mb-4">{v.title}</h3>
                <p className="text-neutral-500 font-light text-sm leading-relaxed">
                  {v.description}
                </p>
              </motion.div>
