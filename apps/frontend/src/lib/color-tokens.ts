...
export const {
  VOID, VOID_DEEP, OBSIDIAN, OBSIDIAN_RAISED, SURFACE, SURFACE_LIGHT, SURFACE_DARK,
  FOREGROUND, TEXT_PRIMARY, TEXT_SECONDARY, TEXT_MUTED,
  GOLD, GOLD_BRIGHT, GOLD_DEEP, GOLD_RGB,
} = COLOR_TOKENS;
