...
export function CTASection() {
  return (
    <section className="relative px-8 md:px-16 py-48 overflow-hidden bg-surface border-t border-border/50">
      ...
      <ScrollFadeIn className="max-w-4xl mx-auto text-center relative z-10">
        <motion.span 
        ...
        <motion.p 
          className="text-lg text-neutral-400 font-light leading-relaxed mb-16 max-w-xl mx-auto"
        >
          Every great project begins with a conversation. Reach out and let's explore
