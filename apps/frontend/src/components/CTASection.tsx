  ...
  return (
    <section className="relative px-8 md:px-16 py-48 overflow-hidden bg-surface border-t border-border/50">
      ...
      <ScrollFadeIn className="mx-auto text-center relative z-10">
        {" "}
        <motion.span className="text-xs uppercase tracking-[0.5em] text-neutral-500 mb-8 block">
          {" "}
          Collaboration{" "}
        </motion.span>{" "}
        ...
        <motion.p className="text-lg text-neutral-400 font-light leading-relaxed mb-16 mx-auto">
          {" "}
