...
const variants = {
  primary:
    'bg-sl-gold-subtle text-sl-void hover:bg-sl-gold-hover shadow-lg shadow-sl-gold-subtle/20 hover:shadow-[0_0_20px_rgba(212,175,55,0.15)]',
  secondary:
  ...
  outline:
    'border border-sl-silver/20 text-sl-alabaster hover:border-sl-gold-hover hover:text-sl-gold-hover hover:bg-sl-gold-subtle/5',
  luxury:
    'bg-white/[0.03] text-sl-alabaster border border-sl-gold-subtle/40 backdrop-blur-2xl hover:border-sl-gold-hover hover:shadow-[var(--artisan-glass-shadow),0_0_35px_rgba(212,175,55,0.25)]',
  couture:
    'bg-gradient-to-r from-sl-void via-sl-obsidian/95 to-black text-sl-alabaster border border-sl-gold-subtle/40 shadow-[var(--artisan-glass-shadow),var(--artisan-glass-highlight)] hover:border-sl-gold-hover hover:shadow-[var(--artisan-glass-shadow),0_0_40px_rgba(212,175,55,0.35)]',
  glass:
...
const LoadingSpinner = () => (
  <span
    aria-hidden
    className="mr-2 inline-block h-4 w-4 animate-spin rounded-full border border-sl-gold-subtle/30 border-t-sl-gold-hover"
  />
);
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const base = cn(
      ...
      'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sl-gold-hover focus-visible:ring-offset-2 focus-visible:ring-offset-sl-void',
