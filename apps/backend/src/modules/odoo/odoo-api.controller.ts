import { Controller, Get, Query, Post, Patch, Delete, Param, Body, UploadedFile, UseInterceptors, VERSION_NEUTRAL, UseGuards } from '@nestjs/common';
...
@Roles('admin')
@Controller({ path: 'odoo', version: VERSION_NEUTRAL })
